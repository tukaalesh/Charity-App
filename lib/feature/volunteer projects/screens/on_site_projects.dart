...
class OnSiteProjects extends StatelessWidget {
  const OnSiteProjects({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: const ConstAppBar(title: "ميداني"),
        body: BlocProvider(
          create: (_) =>
              VolunteerProjectsCubit()..fetchProjectsByType("ميداني"),
                  ...
                  child: RefreshIndicator(
                    ...
                    child: projects.isEmpty
                        ? ListView(
                            ...
                            children: const [
                              SizedBox(height: 200),
                              Center(child: Text("لا يوجد مشاريع حالياً")),
                            ],
                          )
                        : ListView.builder(
                            physics: const AlwaysScrollableScrollPhysics(),
