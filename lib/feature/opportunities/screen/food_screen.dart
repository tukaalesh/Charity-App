...
class _FoodScreenState extends State<FoodScreen> {
  @override
  void initState() {
    super.initState();//تحميل الداتا
    WidgetsBinding.instance.addPostFrameCallback((_) {
     context.read<ProjectsCubit>().loadProjectsByType('nutritional');
    ...
    return BlocConsumer<ProjectsCubit, ProjectsState>(
      ...
      builder: (context, state) {
        return RefreshIndicator(
            onRefresh: () => context.read<ProjectsCubit>().loadProjectsByType('nutritional'),
                  ...
                  return AnimationLimiter(
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        return ProjectCard(project: projects[index]) .staggerListVertical(index);
                      },
                    ),
                  );
