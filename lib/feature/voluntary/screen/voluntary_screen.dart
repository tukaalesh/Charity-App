...
import 'package:charity_app/feature/voluntary/widgets/row_dropdown.dart';
                ...
                children: [
                  ...
                  RowDropdown(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem(value: 'صحي', child: Text('صحي')),
                      DropdownMenuItem(value: "عن بعد", child: Text("عن بُعد")),
                      DropdownMenuItem(value: 'ميداني', child: Text("ميداني")),
                    ],
                    onChanged: (value) {
                      setState(() {
