...
import 'package:charity_app/feature/donation_history/screen/donation_history.dart';
...
import 'package:charity_app/feature/saved_project/screen/saved_project.screen.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context) => DonationAmountCubit()),
        BlocProvider(create: (context) => ProjectsCubit()),
        BlocProvider(create: (context) => DonationHistoryCubit()),
